...
class User < ApplicationRecord
  ...
  has_many(:accepted_sent_follow_requests, class_name: "FollowRequest",foreign_key: "sender_id", primary_key:"id", validate:{:status => "accepted"})
  ...
  has_many(:accepted_received_follow_requests, class_name: "FollowRequest",foreign_key: "recipient_id", primary_key:"id", validate:{:status => "accepted"})
